...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // this.carService.getBulkData(0, 100, true).then((result: any) => {
    //   console.log(result);
    //   this.totalRecords = result.totalRecords;
    //   this.virtualCars = result.data;
    //   // this.totalRecords = result.totalRecords;
    //   // this.virtualCars = result.data;
    //   // return cars;
    // });
  ...
  loadDataOnScroll(event: LazyLoadEvent) {
    ...
    // this.carService.getCarsLarge(event.first, event.rows, true).then((result: any) => {
    //   // console.log(cars);
    //   this.totalRecords = result.totalRecords;
    //   this.virtualCars = result.data;
    //   // return cars;
    ...
    this.carService.getBulkData(event.first, event.rows, true).then((result: any) => {
      console.log(result);
      this.totalRecords = result.totalRecords;
      this.virtualCars = result.data;
      // this.totalRecords = result.totalRecords;
